...
* Stream
** 0x2393
 - initiating the great public prune
 - I've begun maintaining separate vaults after the advent of [[id:e4c2e713-be21-4b79-871a-34eabe93e09d][Nth-roam]]
 - the public space would be maintained for technical notes
 - need to proceed with a strategy as the connection density has grown quite a bit
 - proceeding with impersonal and concise notes henceforth
   - a layer of personality can be added during interpretation time.
   - persisting filler is not efficient
 - will prune a whole bunch of streams
 - verbosity is bad
** 0x2347
